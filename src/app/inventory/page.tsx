                  ...
                  >
                    <div className="space-y-2">
                      <button
                        ...
                        className="w-full py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl transition-all flex items-center justify-center gap-2 text-sm font-medium"
                      >
                        Edit
                      </button>
                      <button
                        ...
                        className="w-full py-2 bg-red-500 hover:bg-red-600 text-white rounded-xl transition-all flex items-center justify-center gap-2 text-sm font-medium"
                      >
