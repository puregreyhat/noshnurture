              ...
              >
                ...
                {emailMessage && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className={`mt-3 text-xs font-medium flex items-start gap-2 ${
                      emailStatus === 'success'
                        ? 'text-emerald-700'
                        : emailStatus === 'error'
                        ? 'text-red-700'
              ...
              >
                ...
                <div className="flex items-center justify-between mb-4 p-3 bg-white/60 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-gray-900">Telegram Notifications</p>
                ...
                {notifMessage && (
                  <motion.div
                    initial={{ opacity: 0, y: -5 }}
                    animate={{ opacity: 1, y: 0 }}
                    className={`mt-4 text-xs font-medium flex items-center gap-2 ${
                      notifStatus === 'success'
                        ? 'text-emerald-700'
                        : notifStatus === 'error'
                        ? 'text-red-700'
