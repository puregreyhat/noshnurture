    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg max-w-md w-full p-6">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h2 className="text-xl font-bold text-gray-900">Smart Label Scanner</h2>
        ...
        {step === 'initial' && !frontImage && !previewImage && (
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-amber-100 text-amber-900 py-3 rounded-lg font-medium border border-amber-300 hover:bg-amber-200 transition flex items-center justify-center gap-2"
            >
        ...
        {step === 'label' && !labelImage && !previewImage && (
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-blue-600 text-white py-3 rounded-lg font-medium flex items-center justify-center gap-2 hover:bg-blue-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <Camera size={20} />
            ...
            <button
              ...
              disabled={!!loadingMessage}
              className="w-full bg-gray-200 text-gray-800 py-3 rounded-lg font-medium hover:bg-gray-300 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Choose from Gallery
            </button>
          </div>
